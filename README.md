...
No data augmentation was performed, since we can't assume that MRI images could be found in clinical settings, with any augmentation method. 

## 3D-U-Net
After every modality (240x240x155) was filtered to (32x7x7x5) in the "Encoder section" (Not a GAN!), we concatenate all modalities together to (128x7*7x5) continue 
